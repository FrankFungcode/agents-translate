...
export function InputArea({
  ...
  return (
    <section className="flex min-h-0 flex-1 flex-col rounded-[28px] bg-white p-5 shadow-soft">
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className="rounded-full bg-ink px-5 py-3 text-sm font-medium text-white transition disabled:cursor-not-allowed disabled:bg-slate-300"
        >
